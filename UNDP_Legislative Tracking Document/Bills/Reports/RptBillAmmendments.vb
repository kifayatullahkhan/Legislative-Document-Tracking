...
Public Class RptBillAmmendments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UNDP_Legislative_Tracking_Document.RptBillAmmendments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBillAmmendments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBillAmmendments = New RptBillAmmendments
        rpt.Site = Me.Site
        Return rpt
    End Function
