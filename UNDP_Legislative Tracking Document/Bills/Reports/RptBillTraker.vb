...
Public Class RptBillTraker
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UNDP_Legislative_Tracking_Document.RptBillTraker.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBillTraker
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBillTraker = New RptBillTraker
        rpt.Site = Me.Site
        Return rpt
    End Function
