...
Public Class RptDailyAgenda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UNDP_Legislative_Tracking_Document.RptDailyAgenda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDailyAgenda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDailyAgenda = New RptDailyAgenda
        rpt.Site = Me.Site
        Return rpt
    End Function
